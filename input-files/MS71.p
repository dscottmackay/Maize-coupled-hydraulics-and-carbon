...
50.96 46.0 60.0 Vcmax25, maximum Rubisco activity at 25 C, umol m-2 s-1
345.29 58.0 100.0 Vpmax25, maximum PEP carbolylase activity at 25 C, umol m-2
...
0.303 0.331 0.258   	Gsref0, reference canopy stomatal conductance (mol m-2 s-1)
...
4.22 3.48 3.0 e_at_saturated_kl
...
1.756 0.9 1.5 ax_Shoot-b_value_(weibull)
1.727 0.9 1.5 ax_Shoot-c_value_(weibull)
1.756 0.9 1.5 lat_Shoot-b_value_(weibull)
1.727 0.9 1.5 lat_Shoot-c_value_(weibull)
1.756 1.5 ax_Root-b_value_(weibull)
1.727 1.5 ax_Root-c_value_(weibull)
1.756 1.383 1.5 lat_Root-b_value_(weibull)
1.727 1.48 1.5 lat_Root-c_value_(weibull)
