...
52.21 46.0 60.0 Vcmax25, maximum Rubisco activity at 25 C, umol m-2 s-1
252.8 58.0 100.0 Vpmax25, maximum PEP carbolylase activity at 25 C, umol m-2
...
0.303 0.251 0.258   	Gsref0, reference canopy stomatal conductance (mol m-2 s-1)
0.54 0.48 0.61  	m (proportion of Gsref0)
...
4.22 2.53 3.0 e_at_saturated_kl
...
2.087 0.9 1.5 ax_Shoot-b_value_(weibull)
2.281 0.9 1.5 ax_Shoot-c_value_(weibull)
2.087 0.9 1.5 lat_Shoot-b_value_(weibull)
2.281 0.9 1.5 lat_Shoot-c_value_(weibull)
2.087 1.5 ax_Root-b_value_(weibull)
2.281 1.5 ax_Root-c_value_(weibull)
2.087 1.383 1.5 lat_Root-b_value_(weibull)
2.281 1.48 1.5 lat_Root-c_value_(weibull)
