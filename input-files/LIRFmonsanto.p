...
-104.647	longitude
3.5	z_ref, m 
0.045 0.035 2.0	lai, single sided
2.0	canopy_height, m
...
51.0 48.85 60.0 Vcmax25, maximum Rubisco activity at 25 C, umol m-2 s-1
49.0 460.0 100.0 Vpmax25, maximum PEP carbolylase activity at 25 C, umol m-2
...
-2.01 -1.44 -1.6 midday_at_sat_kl
...
1.79 1.2 1.522 ax_Shoot-b_value_(weibull)
2.7 1.8 1.889 ax_Shoot-c_value_(weibull)
1.79 1.2 1.522 lat_Shoot-b_value_(weibull)
2.7 1.8 1.889 lat_Shoot-c_value_(weibull)
1.79 1.2 1.522 ax_Root-b_value_(weibull)
2.7 1.8 1.889 ax_Root-c_value_(weibull)
1.79 1.2 1.522 lat_Root-b_value_(weibull)
2.7 1.8 1.889 lat_Root-c_value_(weibull)
...
0.00130 0.0009 0.021 Croot_frac, dim
1.00 13710.0 29460.0 Cstem, kg ha-1
1.0 2.0 Csapwood, kg ha-1
0.00130 0.0009 0.00216 0.1 Croot_coarse_frac, dim
