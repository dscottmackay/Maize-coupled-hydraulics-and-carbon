...
swc<-read.csv(paste(subfolder,"swc2013",".csv",sep=""),header=TRUE)

plotTitle <- "Maize, LIRF 2013"

pdf("plots/maize_swc_2013_V9.pdf", width = 5, height= 9, useDingbats = F)
...
plot(B73$DAY+151,theta01,type="l",lwd=1, lty=1, col="white", cex.axis=1.5, cex.lab=1.5, 
     ylim=c(0.05,0.32), ylab="SWC", xaxt='n')
mtext(plotTitle,side=3,cex=1.0, adj=0, line=0.25)
text(155,0.31,"a",cex=1.5)
theta01 <- as.matrix(0.8*Temperate$theta0+0.2*Temperate$theta1)
lines(Temperate$DAY+151,theta01, lwd=1, lty=1, col="skyblue")
theta01 <- as.matrix(0.8*Tropical$theta0+0.2*Tropical$theta1)
lines(Tropical$DAY+151,theta01, lwd=1, lty=1, col="wheat")
theta01 <- as.matrix(0.8*LIRFmonsanto$theta0+0.2*LIRFmonsanto$theta1)
lines(LIRFmonsanto$DAY+151,theta01, lwd=1, lty=1, col="darkred")
points(swc$DOY,swc$theta01, pch=1,col="black",cex=1.5,lwd=1.5)
box(lwd=1.5)

Axis(side=1, labels=FALSE)
plot(B73$DAY+151,B73$theta1,type="l",lwd=1, lty=1, col="white", cex.axis=1.5, cex.lab=1.5, 
     ylim=c(0.05,0.32), ylab="SWC", xaxt='n')
text(155,0.31,"b",cex=1.5)
lines(Temperate$DAY+151,Temperate$theta1, lwd=1, lty=1, col="skyblue")
lines(Tropical$DAY+151,Tropical$theta1, lwd=1, lty=1, col="wheat")
lines(LIRFmonsanto$DAY+151,LIRFmonsanto$theta1, lwd=1, lty=1, col="darkred")
points(swc$DOY,swc$theta2, pch=1,col="black",cex=1.5,lwd=1.5)
box(lwd=1.5)

Axis(side=1, labels=FALSE)
theta01 <- as.matrix(0.5*B73$theta2+0.5*B73$theta4)
plot(B73$DAY+151,theta01,type="l",lwd=1, lty=1, col="white", cex.axis=1.5, cex.lab=1.5, 
     ylim=c(0.05,0.32), ylab="SWC", xaxt='n')
text(155,0.31,"c",cex=1.5)
theta01 <- as.matrix(0.5*Temperate$theta2+0.5*Temperate$theta4)
lines(Temperate$DAY+151,theta01, lwd=1, lty=1, col="skyblue")
theta01 <- as.matrix(0.5*Tropical$theta2+0.5*Tropical$theta4)
lines(Tropical$DAY+151,theta01, lwd=1, lty=1, col="wheat")
theta01 <- as.matrix(0.5*LIRFmonsanto$theta2+0.5*LIRFmonsanto$theta4)
lines(LIRFmonsanto$DAY+151,theta01, lwd=1, lty=1, col="darkred")
points(swc$DOY,swc$theta3, pch=1,col="black",cex=1.5,lwd=1.5)
box(lwd=1.5)

Axis(side=1, labels=FALSE)
plot(B73$DAY+151,B73$theta4,type="l",lwd=1, lty=1, col="white", cex.axis=1.5, cex.lab=1.5, 
     ylim=c(0.05,0.32), ylab="SWC", xaxt='s')
text(155,0.31,"d",cex=1.5)
lines(Temperate$DAY+151,Temperate$theta4, lwd=1, lty=1, col="skyblue")
lines(Tropical$DAY+151,Tropical$theta4, lwd=1, lty=1, col="wheat")
lines(LIRFmonsanto$DAY+151,LIRFmonsanto$theta4, lwd=1, lty=1, col="darkred")
points(swc$DOY,swc$theta4, pch=1,col="black",cex=1.5,lwd=1.5)
